...
- (GH-476) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.22.9 to go-ci-oldstable-build-v0.22.10 in /dependabot/docker/builds
- (GH-469) Go Dependency: Bump github.com/atc0005/go-nagios from 0.19.0 to 0.20.0
- (GH-471) Go Dependency: Bump golang.org/x/sys from 0.32.0 to 0.33.0
- (GH-473) Go Runtime: Bump golang from 1.23.8 to 1.23.9 in /dependabot/docker/go
...
- (GH-370) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.12 to go-ci-oldstable-build-v0.21.13 in /dependabot/docker/builds
- (GH-388) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.13 to go-ci-oldstable-build-v0.21.15 in /dependabot/docker/builds
- (GH-368) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.9 to go-ci-oldstable-build-v0.21.12 in /dependabot/docker/builds
- (GH-387) Go Dependency: Bump github.com/atc0005/go-nagios from 0.16.1 to 0.17.1
- (GH-364) Go Dependency: Bump golang.org/x/sys from 0.24.0 to 0.25.0
- (GH-383) Go Dependency: Bump golang.org/x/sys from 0.25.0 to 0.27.0
- (GH-366) Go Runtime: Bump golang from 1.22.6 to 1.22.7 in /dependabot/docker/go
- (GH-380) Go Runtime: Bump golang from 1.22.7 to 1.22.9 in /dependabot/docker/go
...
- (GH-330) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.4 to go-ci-oldstable-build-v0.21.5 in /dependabot/docker/builds
- (GH-333) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.5 to go-ci-oldstable-build-v0.21.6 in /dependabot/docker/builds
- (GH-337) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.6 to go-ci-oldstable-build-v0.21.7 in /dependabot/docker/builds
- (GH-343) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.7 to go-ci-oldstable-build-v0.21.8 in /dependabot/docker/builds
- (GH-340) Go Dependency: Bump golang.org/x/sys from 0.22.0 to 0.23.0
- (GH-346) Go Dependency: Bump golang.org/x/sys from 0.23.0 to 0.24.0
- (GH-342) Go Runtime: Bump golang from 1.21.12 to 1.21.13 in /dependabot/docker/go

#### Other

- (GH-338) Push `REPO_VERSION` var into containers for builds
...
- (GH-313) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.20.7 to go-ci-oldstable-build-v0.20.8 in /dependabot/docker/builds
- (GH-317) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.20.8 to go-ci-oldstable-build-v0.21.2 in /dependabot/docker/builds
- (GH-319) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.2 to go-ci-oldstable-build-v0.21.3 in /dependabot/docker/builds
- (GH-323) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.3 to go-ci-oldstable-build-v0.21.4 in /dependabot/docker/builds
- (GH-325) Go Dependency: Bump golang.org/x/sys from 0.21.0 to 0.22.0
- (GH-318) Go Runtime: Bump golang from 1.21.11 to 1.21.12 in /dependabot/docker/go
...
[Unreleased]: https://github.com/atc0005/check-process/compare/v0.3.18...HEAD
[v0.3.18]: https://github.com/atc0005/check-process/releases/tag/v0.3.18
...
[v0.3.10]: https://github.com/atc0005/check-process/releases/tag/v0.3.10
[v0.3.9]: https://github.com/atc0005/check-process/releases/tag/v0.3.9
